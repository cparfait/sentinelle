...
class Config:
    ...
    LDAP_SERVER = os.getenv('LDAP_SERVER', '')          # ex: ldap://dc.exemple.lan
    ...
    LDAP_DOMAIN = os.getenv('LDAP_DOMAIN', '')           # ex: exemple.lan (pour le bind UPN)
    ...
    LDAP_BIND_USER = os.getenv('LDAP_BIND_USER', '')        # ex: svc-sentinelle@exemple.lan
